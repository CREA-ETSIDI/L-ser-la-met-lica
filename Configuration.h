...
#define STRING_CONFIG_H_AUTHOR "Marse" // Who made the changes.
...
// FreakyAttic CNC machine CNC6040 parameters
    #define ABSOLUTE_MAX_FEEDRATE         1000

    #define DEFAULT_AXIS_STEPS_PER_UNIT   {40      , 80       , 4000   , 100.47 }  // default steps per unit for Ultimaker
    #define DEFAULT_MAX_FEEDRATE          {ABSOLUTE_MAX_FEEDRATE, ABSOLUTE_MAX_FEEDRATE, 50, 25 }    // (mm/sec
    ...
    #define DEFAULT_ACCELERATION          650   // X, Y, Z and E max acceleration in mm/s^2 for printing moves
...
//===========================================================================
    ...
    #else
        //Generic Laser.
        #define LASER_POWER             10  // Laser Power
        #define LASER_PWM               5000 // hertz - PWM control freq.
        #define LASER_FOCAL_HEIGHT      35 // z axis position at which the laser is focused
    #endif
